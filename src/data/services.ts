...
export const services: ServicesInterface[] = [
    ...
    { id: "s3", name: "Хирургия", description: "Операция по удалению и сохранению зубов", icon: SurgeryIcon, img: "/services/s3.png" },
    ...
    { id: "s6", name: "Ортодонтия", description: "Исправление зубов и установка брекет-систем", icon: OrthodonticsIcon, img: "/services/s6.png" }
]
