    ...
    return <React.Fragment>
        <div className={styles.infoBlock}>
            ...
            <ul className={styles.info}>
                <li><Link href="/public#about" onClick={onClose}>О Нас</Link></li>
                <li><Link href={"/doctors"} onClick={onClose}>Наши врачи</Link></li>
                <li><Link href="/public#feedback" onClick={onClose}>Отзывы</Link></li>
                <li><Link href={"/services"} onClick={onClose}>Услуги</Link></li>
                <li><Link href="/public#promotions" onClick={onClose}>Акции и скидки</Link></li>
                <li><Link href="/public#contacts" onClick={onClose}>Контакты</Link></li>
            </ul>
        </div>
        <div className={styles.infoBlock}>
            <span>Контакты</span>
            <ul className={styles.info}>
                ...
                <li><Link href="/public"><TimeIcon className="!w-[22px] !h-[22px]"/> Пн-сб с 10:00 до 20:00</Link></li>
