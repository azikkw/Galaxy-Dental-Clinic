    ...
    return <section id="o-klinike" className="lg:mt-5">
        <div className="lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="mb-6 md:mb-4 lg:m-0 lg:order-2 lg:w-[500px] lg:h-[330px] lg:flex lg:flex-col lg:justify-between xl:h-[310px]">
                ...
                <p className="text-mainTextColor font-semibold mb-3 lg:mb-0">
                ...
                <p className="mb-3 lg:mb-0">
                    Сделайте шаг к здоровой и красивой улыбке вместе с нами. Мы предлагаем индивидуальный подход для
                    каждого пациента. Присоединяйтесь к нашему сообществу счастливых людей! Высокие стандарты.
                </p>
            </div>
        ...
        <ul className="grid grid-cols-2 sm:grid-cols-3 lg:flex gap-2.5 mt-7">
            ...
            <li className="w-full h-[110px] flex flex-col justify-center px-4 rounded-[15px] bg-thirdBlueColor">
                <span className="leading-5 text-white lg:font-normal ">Комплексное лечение &#34;под ключ&#34;</span>
            </li>
        </ul>
    </section>
}
