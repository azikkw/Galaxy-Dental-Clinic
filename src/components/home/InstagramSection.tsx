...
const InstagramSection = () => {
    return <section className="relative sm:flex items-center">
        <div className="md:w-[500px]">
            <Title title="Посетите наш блог в Instagram" className="mb-4"/>
        ...
        <Image src="/images/home/instagram.png" alt="2ГИС" fill className="!static !w-full md:!w-[380px] mt-10 md:mt-0"/>
    </section>
}
