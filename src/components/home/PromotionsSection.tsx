    ...
    return <section id="promotions">
        ...
        <div className="bg-secondBlueColor pt-8 rounded-[15px] overflow-hidden sm:pt-12 lg:h-[280px] lg:pt-0 lg:flex lg:items-end">
            <div className="px-5 mb-10 sm:mb-16 sm:px-10 lg:pr-0 lg:mb-0 lg:h-full lg:flex lg:flex-col lg:justify-center">
                ...
                <p className="mb-6 lg:hidden">Акция действует <span className="font-bold">с 31 марта по 6 апреля</span></p>
                <Link className="lg:flex lg:items-center lg:gap-5" href="https://zapis-galaxy.pulse.is/?fbclid=PAZXh0bgNhZW0CMTEAAaYb6sxbuwYaCWSSNzivY0dG2X25qHMuGwOk_dqJTUWQrjDstcQXSQIw3v0_aem_iqEQQeZLB43S5a1VWl2vMQ" target="_blank" aria-label="Ссылка для записи">
                    ...
                    <p className="font-bold text-[17px] hidden lg:block">С 31 марта по 6 апреля</p>
                </Link>
            </div>
