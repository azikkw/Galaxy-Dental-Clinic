    ...
    return <section className="h-[700px] border-b border-mainBorderColor overflow-hidden sm-custom:h-[800px] sm:h-fit lg:flex lg:justify-center">
        <div className="sm:px-6 md:px-10 lg:flex lg:items-end lg:px-[90px] xl:px-0 xl:w-[1050px]">
            <div className="mb-8 px-[15px] sm:px-0 lg:h-full sm:w-[500px] lg:w-[600px] lg:flex lg:flex-col lg:justify-center">
                ...
                <p className="text-[17px] mb-7 lg:mb-11">Акция действует <span className="font-bold">с 1 по 13 октября</span>
                </p>
            ...
            <div className="w-[450px] sm-custom:w-[600px] sm:w-full sm:max-h-[650px] lg:w-fit lg:max-h-[500px] xl:max-h-[550px]">
                <Image src="/images/home/banner.png" alt="Команда Galaxy Dental Clinic" fill className="!static !w-full lg:!ml-[60px] lg:!w-[560px]"/>
            </div>
        </div>
    </section>
}
