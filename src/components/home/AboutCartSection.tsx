...
const AboutCartSection = () => {
    return <section id="about-cart" className="md:flex md:items-center md:justify-between md:gap-10 md:mt-5">
        ...
        <VideoCard previewImg="/images/preview/cart1.jpg" video="/videos/cart.webm" imgClassName="h-[320px] sm:w-full md:w-[350px] lg:w-[430px] lg:h-[300px] xl:w-[500px] xl:h-[300px] rounded-[15px]"/>
    </section>
}
