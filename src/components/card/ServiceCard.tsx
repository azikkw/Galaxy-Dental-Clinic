...
const ServiceCard: React.FC<ServiceProps> = ({ service }) => {
    return <Link href={`/services/${service.id}`} className="!w-full block sm:w-fit p-5 rounded-[15px] bg-secondBlueColor sm:p-[25px] xl:p-[30px]">
        ...
        <p className="text-end text-lg font-semibold text-mainBlueColor sm:text-start sm:text-[17px]">Подробнее...</p>
    </Link>;
}
